...
module "example" {
  source                     = "../../../examples/sap_hana_scaleout_standby_simple_example"
  ...
  startup_script_primary     = "${data.template_file.startup_sap_hana_primary.rendered}"
  startup_script_secondary   = "${data.template_file.startup_sap_hana_secondary.rendered}"
