...
## Requirements
Make sure you go through this [Requirements section](../../modules/sap_hana_scaleout/README.md#requirements) for the SAP HANA HA Submodule.
...
| device\_name\_boot | device name for boot disk | string | n/a | yes |
| device\_name\_pd\_ssd | device name for ssd persistant disk | string | n/a | yes |
